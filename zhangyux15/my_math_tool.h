...
void calc_sp(cv::Mat &matImgOrigin, cv::Mat &output_sp_label, cv::Mat &output_sp_contour, int &output_sp_num);
...
void contour_to_set(std::vector<cv::Point>& vecContours, std::vector<cv::Point>& points_set);
